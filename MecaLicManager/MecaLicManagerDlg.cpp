...
CMecaLicManagerDlg::CMecaLicManagerDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(IDD_MECALICMANAGER_DIALOG, pParent)
	, m_strCbxApptype(_T(""))
	, compCode(_T(""))
	, compRemarks(_T(""))
	, compMngCell(_T(""))
...
BEGIN_MESSAGE_MAP(CMecaLicManagerDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()

	ON_BN_CLICKED(IDC_BUTT_EXIT, &CMecaLicManagerDlg::OnButtExit)

	ON_BN_CLICKED(IDC_BUTT_READ_ALL, &CMecaLicManagerDlg::OnButtReadAll)
	ON_BN_CLICKED(IDC_BUTT_READ_COMP, &CMecaLicManagerDlg::OnButtReadComp)
	ON_BN_CLICKED(IDC_BUTT_READ_USER, &CMecaLicManagerDlg::OnButtReadUser)

	ON_BN_CLICKED(IDC_BUTT_LIC_MAKE, &CMecaLicManagerDlg::OnButtLicMake)
	ON_BN_CLICKED(IDC_BUTT_LIC_READ, &CMecaLicManagerDlg::OnButtLicRead)

	ON_CBN_SELCHANGE(IDC_COMBO_APPTYPE, &CMecaLicManagerDlg::OnCbxApptype)

	ON_BN_CLICKED(IDC_BUTT_SAVE_AS_ALL, &CMecaLicManagerDlg::OnButtAllSaveAs)
	ON_BN_CLICKED(IDC_BUTT_COMP_SAVE_AS, &CMecaLicManagerDlg::OnButtCompSaveAs)
	ON_BN_CLICKED(IDC_BUTT_USER_SAVE_AS, &CMecaLicManagerDlg::OnButtUserSaveAs)

	ON_BN_CLICKED(IDC_BUTT_SAVE_ALL, &CMecaLicManagerDlg::OnButtAllSave)
	ON_BN_CLICKED(IDC_BUTT_COMP_SAVE, &CMecaLicManagerDlg::OnButtCompSave)
	ON_BN_CLICKED(IDC_BUTT_USER_SAVE, &CMecaLicManagerDlg::OnButtUserSave)

	ON_EN_UPDATE(IDC_EDIT_MAC1, &CMecaLicManagerDlg::OnUpdateMac1)
	ON_EN_UPDATE(IDC_EDIT_MAC2, &CMecaLicManagerDlg::OnUpdateMac2)
	ON_EN_UPDATE(IDC_EDIT_MAC3, &CMecaLicManagerDlg::OnUpdateMac3)
...
// CMecaLicManagerDlg 메시지 처리기

BOOL CMecaLicManagerDlg::OnInitDialog()
{
...
void CMecaLicManagerDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CMecaLicManagerDlg::OnPaint()
{
	if (IsIconic())
	{
...
//  이 함수를 호출합니다.
HCURSOR CMecaLicManagerDlg::OnQueryDragIcon()
{
...
// 전체 정보 읽기 버튼.
void CMecaLicManagerDlg::OnButtReadAll()
{
	reading(0, allDataAddress);
}

// 회사 정보 읽기 버튼.
void CMecaLicManagerDlg::OnButtReadComp()
{
	reading(1, compDataAddress);
}

//사용자 정보 읽기 버튼.
void CMecaLicManagerDlg::OnButtReadUser()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
...
void CMecaLicManagerDlg::OnButtCompSaveAs()
{
	CString writeStr[7];
...
void CMecaLicManagerDlg::OnButtUserSaveAs()
{
...
void CMecaLicManagerDlg::OnButtAllSave()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
...
// 2. 새로 저장한다.
// 3. 취소
void CMecaLicManagerDlg::OnButtCompSave()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
...
void CMecaLicManagerDlg::OnButtUserSave()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
...
CString CMecaLicManagerDlg::openOrSaveDlg(BOOL isOpen, CString address)
{
...
void CMecaLicManagerDlg::reading(int readType, CString dataPath)
{
	CString filePath;
	CString alert;
	CStdioFile txtFile;
...
void CMecaLicManagerDlg::OnUpdateMac2()
{
	macAddControl(1);
}


void CMecaLicManagerDlg::OnUpdateMac3()
{
	macAddControl(2);
}


void CMecaLicManagerDlg::OnUpdateMac4()
{
	macAddControl(3);
}


void CMecaLicManagerDlg::OnUpdateMac5()
{
	macAddControl(4);
}


void CMecaLicManagerDlg::OnUpdateMac6()
{
	macAddControl(5);
}

void CMecaLicManagerDlg::macAddControl(int boxNum)
{
	UpdateData(TRUE);
